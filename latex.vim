...
" Mapeamentos
	"augroup LaTeX_tmp
	"	autocmd!
	"	autocmd FileType tex nnoremap <buffer> <localleader>r :w<cr>:! pdflatex 03-tese_Rafael.tex<cr>
	"	autocmd FileType tex nnoremap <buffer> <localleader>b :w<cr>:! bibtex 03-tese_Rafael.aux<cr>
	"	autocmd FileType tex nnoremap <buffer> <localleader>p :w<cr>:! zathura 03-tese_Rafael.pdf &<cr><cr>
	"	autocmd FileType tex nnoremap <buffer> ZW :w<cr>:! pdflatex 03-tese_Rafael.tex &> /dev/null <cr><cr>
	"augroup END
	...
	augroup LaTeX_gerais
		...
		" Preview
		autocmd FileType tex nnoremap <buffer> <localleader>p :w<cr>:! zathura %:r.pdf &<cr><cr>
		autocmd FileType tex nnoremap <buffer> ZW :w<cr>:! pdflatex % &> /dev/null <cr><cr>
		"autocmd FileType tex nnoremap <buffer> <localleader>p :w<cr>:! mkdir -p /tmp/vimPrev && cp % /tmp/vimPrev/prev-% && pdflatex -output-directory /tmp/vimPrev /tmp/vimPrev/prev-% &> /dev/null<cr>:! zathura /tmp/vimPrev/prev-%:r.pdf &<cr><cr>:! cd /tmp/vimPrev && bibtex prev-%:r.aux && cd - <cr><cr>
		"autocmd FileType tex nnoremap <buffer> ZW :w<cr>:! cp % /tmp/vimPrev/prev-% && pdflatex -output-directory /tmp/vimPrev /tmp/vimPrev/prev-% &> /dev/null <cr><cr>

		"autocmd FileType tex nnoremap <buffer> <localleader>p :w<cr>:! zathura %:r.pdf &<cr>
	...
	augroup LaTeX_bibli
		...
		"autocmd FileType bib inoremap <buffer> <C-Space> <ESC>/<+*><CR>cf>
		"autocmd FileType bib nnoremap <buffer> <tab> /<+.*+><CR>"_c/+>/e<CR>
	augroup END
